import { Snowflake, Ship, Glasses, Waves, Camera, Plane, type LucideIcon } from "lucide-react";
import { Reveal } from "@/components/Reveal";
import { HIGHLIGHTS } from "@/lib/data";

const ICONS: Record<string, LucideIcon> = { Snowflake, Ship, Glasses, Waves, Camera, Plane };
