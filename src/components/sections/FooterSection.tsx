    ...
    <footer id="footer" className="bg-ocean text-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-4">
        <div>
          ...
          <img src={BRAND.logo} alt="Japangisme" className="h-14 w-auto bg-white/90 p-1" />
          <p className="mt-3 text-sm text-white/80">Open trip Mentawai full-service dari Tuapejat.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-white/80">
            <li><a href={BRAND.waUrl} className="hover:text-gold">WA {BRAND.phone}</a></li>
            <li>IG @{BRAND.ig}</li>
        ...
        <div>
          ...
          <div className="mt-3 flex gap-3">
            <a href={`https://instagram.com/${BRAND.ig}`} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="rounded-full bg-white/10 p-2 hover:bg-white/20">
            ...
            <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="rounded-full bg-white/10 p-2 hover:bg-white/20">
